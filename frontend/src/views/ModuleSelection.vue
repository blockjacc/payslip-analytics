...
export default {
  ...
  methods: {
    selectModule(module) {
      ...
      } else if (module === 'deepdive') {
        // For now, use placeholder emp_id and date for testing
        this.$router.push(`/deepdive/${this.companyId}/55554/2025-05-01`);
      }
